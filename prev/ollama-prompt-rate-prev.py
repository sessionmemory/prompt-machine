...
def select_model(models):
    ...
    print("" + msg_word_enter() + " 'exit' to stop the program.")
    ...
    while True:
        ...
        try:
            ...
            if 0 <= model_idx < len(models):
                ...
                print(msg_word_invalid() + " model number, please try again.")
        except ValueError:
            print(msg_word_invalid() + " input, please " + msg_word_enter() + " a number.")
    ...
    while True:
        ...
        try:
            ...
            if category_idx == -1:
                ...
                print(msg_word_invalid() + " category number, please try again.")
        except ValueError:
